...
#define PRINT_ELEMENT "i"    // Change this to change format specifier.
typedef int ListElement; // Change this to change the type of List.
...
// Access Functions
ListElement length(List L); // Get length of list
ListElement index(List L); // Get index of cursor
