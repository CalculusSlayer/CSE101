...
GraphElement getDiscover(Graph G, GraphElement u); // Gets time the node was discovered.
GraphElement getFinish(Graph G, GraphElement u);  // Gets time node turns black.
...
/*** Other operations ***/
Graph transpose(Graph G); // Returns transpose of graph.
Graph copyGraph(Graph G); // Returns copy of graph.
